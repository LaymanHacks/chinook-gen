...
Namespace Chinook.Data.SqlDbCommandProvider
    ...
    Public Class SqlDbMediaTypeCommandProvider
        ...
        ''' <returns></returns>
        ''' <remarks></remarks> 
        Public Function GetGetPageableDbCommand(ByVal sortExpression As String, ByVal startRowIndex As Int32, ByVal maximumRows As Int32) As IDbCommand Implements IDbMediaTypeCommandProvider.GetGetPageableDbCommand


            Dim command As New SqlCommand("MediaType_GetPageable")
            command.CommandType = CommandType.StoredProcedure
