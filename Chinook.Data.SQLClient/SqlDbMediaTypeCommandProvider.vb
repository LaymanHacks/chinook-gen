...
Namespace Chinook.Data.SqlDbCommandProvider
    ...
    Public Class SqlDbMediaTypeCommandProvider
        ...
        ''' <returns></returns>
        ''' <remarks></remarks> 
        Public Function GetGetPageableDbCommand(ByVal sortExpression As String, ByVal startRowIndex As Int32, ByVal pageSize As Int32) As IDbCommand Implements IDbMediaTypeCommandProvider.GetGetPageableDbCommand
