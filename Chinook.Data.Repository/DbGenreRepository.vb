...
Namespace Chinook.Data.Repository
    ...
    Public Class DbGenreRepository
        ...
        Public Function GetPageable(ByVal sortExpression As String, ByVal startRowIndex As Int32, ByVal maximumRows As Int32) As ICollection(Of Genre) Implements IGenreRepository.GetPageable
            Dim command As IDbCommand = _dbGenreCommandProvider.GetGetPageableDbCommand(sortExpression, startRowIndex, maximumRows)
            command.Connection = _dbConnHolder.Connection
            _dbConnHolder.Open()
            Dim entList As New Collection(Of Genre)
            Dim reader As New SafeDataReader(command.ExecuteReader(CommandBehavior.CloseConnection))
