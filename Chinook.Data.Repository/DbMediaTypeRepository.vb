...
Update( CInt(.MediaTypeId), .Name)
  ...
  <Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Insert, False)> _ 
    Public Function Insert(ByVal mediaType as MediaType)  as Int32 Implements IMediaTypeRepository.Insert
             With MediaType
 Return Insert( CInt(.MediaTypeId), .Name)
       End With
...
Delete( CInt(.MediaTypeId))
  ...
  <Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.[Select], false)> _ 
    Public Function GetDataPageable( ByVal sortExpression As String,  ByVal page As Int32,  ByVal pageSize As Int32)  as ICollection(Of MediaType) Implements IMediaTypeRepository.GetDataPageable
        Dim command As IDbCommand = _dbMediaTypeCommandProvider.GetGetDataPageableDbCommand(sortExpression, page, pageSize)
            command.Connection = _dbConnHolder.Connection
            _dbConnHolder.Open()
              Dim entList as new Collection(Of MediaType)
            Dim reader As New SafeDataReader(command.ExecuteReader(CommandBehavior.CloseConnection))
