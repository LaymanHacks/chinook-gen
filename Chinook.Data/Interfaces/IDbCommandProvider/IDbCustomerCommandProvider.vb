...
Namespace Chinook.Data.DbCommandProvider
    Public Interface IDbCustomerCommandProvider
        ...
        Function GetGetDataBySupportRepIdPageableDbCommand(ByVal sortExpression As String, ByVal startRowIndex As Int32, ByVal pageSize As Int32, ByVal supportRepId As Int32) As IDbCommand
