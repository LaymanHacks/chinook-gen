...
Namespace Chinook.Data.Repository
    ...
    Public Class DbPlaylistRepository
        ...
        Public Function Insert(ByVal playlist As Playlist) As Int32 Implements IPlaylistRepository.Insert
            With playlist
                Return Insert(CInt(.PlaylistId), .Name)
            End With
        ...
        Public Function GetDataPageable(ByVal sortExpression As String, ByVal page As Int32, ByVal pageSize As Int32) As ICollection(Of Playlist) Implements IPlaylistRepository.GetDataPageable
            Dim command As IDbCommand = _dbPlaylistCommandProvider.GetGetDataPageableDbCommand(sortExpression, page, pageSize)
            command.Connection = _dbConnHolder.Connection
            _dbConnHolder.Open()
            Dim entList As New Collection(Of Playlist)
            Dim reader As New SafeDataReader(command.ExecuteReader(CommandBehavior.CloseConnection))
        ...
        ''' <remarks></remarks> 
        <Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.[Select], False)> _
        Public Function GetPlaylistsByTrackIdPageable(ByVal trackId As Int32, ByVal sortExpression As String, ByVal page As Int32, ByVal pageSize As Int32) As ICollection(Of Playlist) Implements IPlaylistRepository.GetPlaylistsByTrackIdPageable
            Dim command As IDbCommand = _dbPlaylistCommandProvider.GetGetPlaylistsByTrackIdPageableDbCommand(trackId, sortExpression, page, pageSize)
            command.Connection = _dbConnHolder.Connection
            _dbConnHolder.Open()
            Dim entList As New Collection(Of Playlist)
            Dim reader As New SafeDataReader(command.ExecuteReader(CommandBehavior.CloseConnection))
